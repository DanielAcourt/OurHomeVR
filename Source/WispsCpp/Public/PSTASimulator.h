...
private:
    ...
    /**
     * @brief If true, PNDF violations will be logged as non-fatal warnings instead of fatal errors.
     * This allows the simulation to continue, providing flexibility for "first-draft" personal simulations.
     */
    UPROPERTY(EditAnywhere, Category = "PSTAS Executive")
    bool bEnableSoftFailures = false;

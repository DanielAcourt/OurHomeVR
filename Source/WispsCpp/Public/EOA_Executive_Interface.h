...
namespace EOA_Executive_Interface
{
    ...
    inline void ForceOverrideShutdown()
    {
        ...
        {
            // In a real-world scenario, this would remain a 'Fatal' log.
            // For simulation purposes, we use 'Warning' to prevent the editor from closing during tests.
            UE_LOG(LogTemp, Warning, TEXT("[EOA FALLBACK] EOA override has been forcibly shut down by P0 safety floor due to a critical PNDF violation."));
